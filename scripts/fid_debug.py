...
from src.modules.fid_score import compute_FID_score, compute_FID_score_for_loaders
...
def main():
    ...
    FID_score = compute_FID_score_for_loaders(dataloader1, dataloader2, engine.device)
