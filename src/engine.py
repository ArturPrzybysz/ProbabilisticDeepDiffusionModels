...
class Engine(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        self.log("test_mse_means_1", nll["MSE_means_1"])
        self.log("test_mse_means_2", nll["MSE_means_2"])
        self.log("test_mse_means_3", nll["MSE_means_3"])
        self.log("test_mse_means_4", nll["MSE_means_4"])
        self.log("test_mse_means_5", nll["MSE_means_5"])
    ...
    def calculate_likelihood(self, x):
        ...
        MSE_means_stack = th.stack(MSE_means_list)
        MSE_means = th.mean(MSE_means_stack)

        return {
            "MSE": MSE,  # TODO
            "MSE_1": th.mean(MSE_stack[:200]),
            "MSE_2": th.mean(MSE_stack[200:400]),
            "MSE_3": th.mean(MSE_stack[400:600]),
            "MSE_4": th.mean(MSE_stack[600:800]),
            "MSE_5": th.mean(MSE_stack[800:]),
            "MSE_means_1": th.mean(MSE_means_stack[:200]),
            "MSE_means_2": th.mean(MSE_means_stack[200:400]),
            "MSE_means_3": th.mean(MSE_means_stack[400:600]),
            "MSE_means_4": th.mean(MSE_means_stack[600:800]),
            "MSE_means_5": th.mean(MSE_means_stack[800:]),
            "MSE_means": MSE_means,
